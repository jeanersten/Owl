...
namespace Owl
{
  ...
  public:
    ...
    inline static EventType GetStaticType() { return EventType::KEYBOARD_KEY_PRESSED; }
  ...
  public:
    ...
    inline static EventType GetStaticType() { return EventType::KEYBOARD_KEY_RELEASED; }
    EventType               GetEventType() const override final;
    const Char*             GetName() const override final;
    std::string             GetString() const override final;
  };
